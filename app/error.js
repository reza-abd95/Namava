...
export default function Error({error, reset}) {
    return (
        <div className="w-full h-screen bg-[#121212FF] flex flex-col justify-center items-center ">
            <h1 className="font-iranyekanBold text-white text-[25px] mb-[10px]">اوپسسس...</h1>
            <h2 className="font-iranyekanBold text-white text-[20px] mb-[20px]">یک چیزی اشتباه است!</h2>
