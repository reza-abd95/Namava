...
const Comments = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center'>
            <div className=" w-full h-[200px] mt-[200px] pt-[32px] pb-[19px] px-[20px] text-[16px]  bg-[#222327] flex flex-col justify-center items-center ">
                ...
                <div className="w-full flex items-center justify-start  ">
                    ...
                    <input className=" w-[70%] mt-[1px] h-[40px] rounded-[6px] font-iranyekanRegular placeholder:text-[12px] placeholder:text-[#666666] align-middle placeholder:align-middle py-[11px] px-[12px]  mr-[16px] ml-[8px] border-0 outline-0 " type="text" placeholder="نظرتان درباره این فیلم چیست؟"/>
                ...
                <div className="w-full flex items-center align-middle justify-start mt-[12px]">
                    <label className="block relative pl-[35px] cursor-pointer">
                        ...
                        <span className="absolute bottom-0 right-0 border border-white rounded-[6px] h-[20px] w-[20px] bg-[#222327]"></span>
                        <span className="relative font-iranyekanRegular text-[10px] text-white mr-[28px] mb-[15px]">این نظر حاوی اسپویلر است و داستان فیلم را لو می‌دهد.</span>
                    </label>
                </div>
            </div>
            <div className="w-full px-[20px] pt-[20px] text-[16px] bg-[#222327] flex flex-row justify-start items-start">
                <div className="w-[17.5%] flex items-start justify-start mt-[1px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 40 40"
                         className="t-profile-0-1-1525">
                        <path className="fill-white"
                              d="M1429.6,630.193a19.238,19.238,0,1,0,19.239,19.238A19.26,19.26,0,0,0,1429.6,630.193Zm0,6.383a6.783,6.783,0,1,1-6.782,6.782A6.79,6.79,0,0,1,1429.6,636.576Zm12.7,22.675a15.8,15.8,0,0,1-12.7,6.4,16.2,16.2,0,0,1-12.632-6.37,4.141,4.141,0,0,1-.7-3.937,8.936,8.936,0,0,1,5.3-5.2,2.552,2.552,0,0,1,2.335.239,9.864,9.864,0,0,0,11.379,0,2.564,2.564,0,0,1,2.352-.234,8.936,8.936,0,0,1,5.3,5.241A4.141,4.141,0,0,1,1442.3,659.251Z"
            ...
            <div className="w-full px-[20px] text-[16px] bg-[#222327] flex flex-row justify-start items-start">
                <div className="w-[17.5%] flex items-start justify-start mt-[1px]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 40 40"
                         className="t-profile-0-1-1525">
                        <path className="fill-white"
                ...
                <div className="w-full pb-[50px] flex flex-col items-start justify-center mt-[3px] ">
                    ...
                    <span className='text-[12px] font-iranyekanRegular text-white'>افتضاح</span>
                    <div className="flex flex-row justify-start items-center w-full gap-[35px] mt-[30px] pr-[5px] ">
                        <span className="flex flex-row gap-4 font-iranyekanRegular text-[12px] text-[#AAAAAA]"><Image className="w-[18px] h-[18px] transform -scale-x-100 cursor-pointer"  src={Like} alt="like"/> ۱</span>
                        <span className="flex flex-row gap-4 font-iranyekanRegular text-[12px] text-[#AAAAAA]"><Image className="w-[18px] h-[18px] transform -scale-y-100 cursor-pointer" src={Like} alt="dislike"/> ۲</span>
                    </div>
                    <hr className="w-full mt-[30px]"/>
                </div>
            </div>
