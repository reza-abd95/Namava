                        ...
                        <div>
                            <ul className="list-none w-full flex justify-center items-center flex-col">
                                <li className="profileBox__list">
                                   ...
                                   <Link href="/bookmarks"> <p className="profileBox__list-text">لیست من</p></Link>
                                </li>
                                <li className="profileBox__list">
                                    ...
                                    <Link href="/bookmarks/liked"> <p className="profileBox__list-text">علاقه مندی ها</p></Link>
                                </li>
                                {/*<li className="profileBox__list">*/}
