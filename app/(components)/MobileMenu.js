...
const MobileMenu = ({top}) => {
    ...
    return (
        <>
            <div className={"absolute w-screen h-screen bg-zinc-800 opacity-30 right-0" + " " +top} onClick={closeMenu_handller} ref={darkDivRef} ></div>
            <div className={"w-[250px] bg-[#222327] z-100 transition duration-[20s] ease-linear absolute h-screen tab:hidden right-0"+ " " + top} ref={MenuRef}>
