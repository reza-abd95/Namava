...
export default function HeaderSliderComponent({id,title,age,year,movieTime,imdb,like,description,imageUrl,imageMobileUrl,actors}) {
      ...
      <div className="text-[#fff]">
        <div className="w-full h-full relative flex flex-col ">
          <div className="relative mb-[12px] ml:mb-[32%] min-[600px]:mb-[20%] min-[700px]:mb-[11%] tab:mb-[64px] min-[900px]:mb-2 min-[1050px]:mb-0" >
            ...
            <div className="absolute inset-1 bg-gradient-to-l from-[#121212] via-transparent to-transparent"></div>
          </div>
