        ...
        <div className="w-full h-full relative flex flex-col ">
          ...
          <div className="w-[45%] mb-[44px] ml:w-[28%]  ml:mr-[20px] ml:mb[50px] tab:w-[20%] tab:mr-8 tab:mb-6 des:mr-11 des:w-[22%]">
           ...
           <div className="flex flex-col justify-center items-center px-[14px]  text-center ml:block ml:text-start ml:px-[20px] tab:px-8 des:px-11">
            <h2 className='mb-6 ml:mb-4 tab:text-[19px] tab:mb-3 des:text-[21px] large:text-[24px]'>آواتار</h2>
             <div className="max-[1279px]:hidden flex flex-row justify-between items-center w-[410px]">
               <div className="bg-yellow-500 px-3 rounded-[4px] py-1 flex items-center text-center my-6">
                <p className="text-[15px] text-center large:text-[17px]">+۱۲</p>
              </div>
              <p className="text-[15px] large:text-[17px]">۲۰۲۲</p>
              <p>۱۲۰ دقیقه</p> 
              <div className=" h-4 flex flex-row items-center">
                ...
                className="ml-1 h-3 ml:h-[14px]"
                  ...
                  alt="imdb"
                /> 
                   <p className="text-[15px] large:text-[17px]">6.7</p>
              </div>
              ...
              className="ml-1 mb-1"
                  ...
                  alt="like"
                />
                <p className="text-[15px] large:text-[17px]">۹۱٪</p>
              </div>
              ...
              className="ml-1"
                  ...
                  alt="subtitle"
                />
                <p className="text-[15px] large:text-[17px]">زیرنویس</p>
              </div> 
            </div> 
             
             <p className="text-[13px] w-[500px] max-[799px]:hidden des:text-[15px] des:w-[550px] large:text-[17px] large:w-[700px]">
            ...
            <p className="text-[13px] leading-loose  ml:mb-[48px] tab:mb-9 tab:mt-3 des:text-[15px] large:text-[17px]">
