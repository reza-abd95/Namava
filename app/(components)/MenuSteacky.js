                ...
                <div className={"w-[250px] hidden bg-[#222327] z-100 transition duration-[20s] ease-linear absolute h-screen tab:hidden right-0"+ " " + "top-[0]"} ref={MenuRef}>
                    ...
                    <div className="w-full px-[24px]">
                        <ul>
                            ...
                            <li className={(pathName == "/categories") ? "mobile__menu-list fill-[#6eb8ff] text-[#6eb8ff]" : "text-white hover:fill-[#6eb8ff] fill-white mobile__menu-list"} onClick={()=>{route.push("/categories");closeMenu_handller()}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
