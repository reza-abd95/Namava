...
export default function MenuSteacky () {
            ...
            <div>
                ...
                <div className={"w-[250px] hidden bg-[#222327] z-100 transition duration-[20s] ease-linear absolute h-screen tab:hidden right-0"+ " " + "top-[100px]"} ref={MenuRef}>
                    ...
                    <div className="w-full px-[24px]">
                        <ul>
                            <li className={(pathname == "/") ? "mobile__menu-list fill-[#6eb8ff] text-[#6eb8ff]" : "mobile__menu-list text-white fill-white" } onClick={()=>{route.replace("/")}}>
                            ...
                            <li className={(pathname == "/movies") ? "mobile__menu-list fill-[#6eb8ff] text-[#6eb8ff]" : "mobile__menu-list text-white fill-white" } onMouseOver={ChangeFill} onMouseLeave={ChangeFilloff} onClick={()=>{route.replace("/movies")}}>
                            ...
                            <li className={(pathname == "/categories") ? "mobile__menu-list fill-[#6eb8ff] text-[#6eb8ff]" : "text-white hover:fill-[#6eb8ff] fill-white mobile__menu-list"} onClick={()=>{route.replace("/categories")}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30">
